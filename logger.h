...
//Log functions
int logger(STREAM stream, char* file_name, char* type, const char *format, ...);
 ...
 */
#define log_info(format, ...) logger(stdout, __FILE__, "INFO", format, ##__VA_ARGS__);
 ...
 * @return output of logger
 */
#define log_error(format, ...) logger(stdout, __FILE__, "ERROR", format, ##__VA_ARGS__);
 ...
 * @return output of logger
 */
#define log_warn(format, ...) logger(stdout, __FILE__, "WARN", format, ##__VA_ARGS__);
 ...
 * @return output of logger
 */
#define log_custom(name, format, ...) logger(stdout, __FILE__, name, format, ##__VA_ARGS__);
